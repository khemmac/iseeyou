...
<head>
	...
	<link href="<?= base_url('assets/js/tooltipster/css/tooltipster.css') ?>" rel="stylesheet">
	<script type="text/javascript" src="<?= base_url('assets/js/tooltipster/js/jquery.tooltipster.min.js') ?>"></script>
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('.navbar-main a').hover(function () {
				...
				console.log('xxxxxx hover', el.children('.dropdown-menu'));
			}, function () {
				var el = $(this).parent();
				el.children('.dropdown-menu').show();
				el.siblings().children('.dropdown-menu').hide();
